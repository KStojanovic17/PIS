...
const
  ...
  arrActivitiesList: array [0 .. dActivitiesCount - 1] of string =
    (sActivityInbox, sActivityTeams, sActivityChat, sActivityCalls, sActivityTasks,
    sActivitySignInName, sActivitySignUp, sActivityHomeName, sActivityData, sActivitySettings, sActivityAccount);
